...
export default function StudentLoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-primary/5 via-background to-accent/10 relative overflow-hidden">
      ...
      <main className="flex-1 flex items-center justify-center p-4 relative z-10">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground text-lg">Đăng nhập để quản lý luận văn của bạn</p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  required
                  className="bg-background/50 h-11 border-border/50 focus:border-primary transition-colors"
                />
              </div>
